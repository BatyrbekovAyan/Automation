...
<reference>
@/Users/ayan/Projects/Automation/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/ayan/Projects/Automation/.claude/get-shit-done/references/user-profiling.md` to load:
