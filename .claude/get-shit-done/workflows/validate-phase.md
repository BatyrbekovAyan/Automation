...
```
Task(
  prompt="Read /Users/ayan/Projects/Automation/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ayan/Projects/Automation/.claude/get-shit-done/templates/VALIDATION.md`
