...
<required_reading>
@/Users/ayan/Projects/Automation/.claude/get-shit-done/references/ai-frameworks.md
@/Users/ayan/Projects/Automation/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/ayan/Projects/Automation/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/ayan/Projects/Automation/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/ayan/Projects/Automation/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/ayan/Projects/Automation/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/ayan/Projects/Automation/.claude/agents/gsd-eval-planner.md for instructions.
