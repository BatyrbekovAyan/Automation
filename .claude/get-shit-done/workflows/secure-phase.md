...
```
Task(
  prompt="Read /Users/ayan/Projects/Automation/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ayan/Projects/Automation/.claude/get-shit-done/templates/SECURITY.md`
