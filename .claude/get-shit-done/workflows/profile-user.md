...
Key references:
- @/Users/ayan/Projects/Automation/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/ayan/Projects/Automation/.claude/get-shit-done/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/ayan/Projects/Automation/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/ayan/Projects/Automation/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/ayan/Projects/Automation/.claude/get-shit-done/USER-PROFILE.md" "/Users/ayan/Projects/Automation/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/ayan/Projects/Automation/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/ayan/Projects/Automation/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/ayan/Projects/Automation/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/ayan/Projects/Automation/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /Users/ayan/Projects/Automation/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/ayan/Projects/Automation/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/ayan/Projects/Automation/.claude/commands/gsd/dev-preferences.md"
...
Display: "✓ Added profile section to /Users/ayan/Projects/Automation/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/Users/ayan/Projects/Automation/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/ayan/Projects/Automation/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/ayan/Projects/Automation/.claude/commands/gsd/dev-preferences.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /Users/ayan/Projects/Automation/.claude/CLAUDE.md
```
