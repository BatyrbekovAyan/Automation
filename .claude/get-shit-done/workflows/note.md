...
- **Global scope**: `/Users/ayan/Projects/Automation/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/ayan/Projects/Automation/.claude/notes/`)
...
2. Glob `/Users/ayan/Projects/Automation/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/ayan/Projects/Automation/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/ayan/Projects/Automation/.claude/notes/` — works in any directory
