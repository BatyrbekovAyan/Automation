...
```bash
INIT=$(node "/Users/ayan/Projects/Automation/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ayan/Projects/Automation/.claude/get-shit-done/templates/spec.md.
