...
```bash
node "/Users/ayan/Projects/Automation/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `/Users/ayan/Projects/Automation/.claude/get-shit-done/templates/retrospective.md`.
