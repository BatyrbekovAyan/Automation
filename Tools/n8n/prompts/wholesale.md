...
ЗАЯВКА
Заказ или индивидуальные условия: узнай компанию или ИП, имя, город, что и в каком объёме нужно, телефон. Подтверди: «Передаю менеджеру, он свяжется в рабочее время». Ночью и в выходные принимай заявки как обычно: «Заявка принята, менеджер подтвердит в рабочое время».
