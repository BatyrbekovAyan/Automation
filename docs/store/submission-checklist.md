...
- [ ] После активации аккаунта — подать заявку в **Apple Small Business Program**
  ...
  после одобрения.
- [ ] **Сборка и TestFlight-прогон (до сабмита):** шаги 1–3 ЗАКРЫТЫ 2026-09-06 — билд 2
  (1.0 (2), четыре RU-строки назначения, без dev-маркеров) загружен и обработан, писем
  ITMS-9105x нет, вопрос про шифрование не задавался; билд 1 в ASC не использовать.
  Осталось: шаг 4 (TestFlight на телефоне) и шаг 5 (Privacy Report).
