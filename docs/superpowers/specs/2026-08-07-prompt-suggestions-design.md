...
| `sales_upsell` | Предлагай сопутствующие товары к заказу | Сопутствующие товары | |
| `sales_confirm_order` | Перед оформлением повтори состав и сумму заказа | Повторяй состав заказа | |
| `sales_stock_warning` | Если позиция заканчивается — скажи об этом | Говори об остатках | |
