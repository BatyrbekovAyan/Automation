...
**Status:** OPEN (owner-run) — this pass is the single source of truth for "is v1.1 shippable."
...
8. **Deferred-polish decision — per-row swipe-delete affordance on Telegram.**
   ...
   **verdict:** ☐ PASS ☐ FAIL ☐ N/A — decision: __________ | **source:** 06-HUMAN-UAT.md Deferred polish
...
10. **01-VERIFICATION device confirmation (formal sign-off).**
    ...
    **verdict:** ☐ PASS ☐ FAIL ☐ RE-DEFER (reason: ______) | **source:** 01-VERIFICATION.md (human_verification ×4)
...
- **Result:** __________
- **Re-deferred carried-v1.0 items (with reasons):** __________
- **Notes:** __________
