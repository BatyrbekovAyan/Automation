...
**Status:** RUN 2026-07-15/16 → re-verify 2026-07-17 (08-10) → round-2 re-verify 2026-07-17 (08-16) — **Overall: ISSUES** (open: **D2-ext**, **D12**, **D13** — see §Defects; resolved through round 2: D1–D8 core set, D10, D11, D2 core; D9 SUPERSEDED by owner decision → D13 cover). This pass is the single source of truth for "is v1.1 shippable."
