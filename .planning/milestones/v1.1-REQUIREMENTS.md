# ARCHIVED — Milestone v1.1 Telegram Parity

**Archived:** 2026-07-28
**Status:** ✅ SHIPPED 2026-07-21
**Note:** This is the requirements set as it stood at v1.1 close. Milestones v1.2
(Reply-Trigger Discipline) and v1.3 (First-Run Onboarding) shipped WITHOUT a
formalized REQUIREMENTS.md — their requirement ids (BATCH-01..03, SUP-01..05,
ONB-01..05) are traced in their phase plans, summaries and roadmap archives
instead. A fresh REQUIREMENTS.md is created by `/gsd-new-milestone`.
